const inputLogin = signinForm.querySelector('[type="email"]'),
  inputPassword = signinForm.querySelector('[type="password"]'),
  signinSubmit = signinForm.querySelector(".signin-form__button");
try {
...
signinSubmit.addEventListener("click", function (t) {
  inputLogin.value
    ...
    storage
      ? ((inputLogin.value = storage), (inputPassword.value = storage))
      : isStorageSupport &&
